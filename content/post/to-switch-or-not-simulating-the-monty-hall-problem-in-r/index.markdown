...
It would seem that we have a winner! Clearly, switching doors is the dominating strategy vindicating vos Savant’s perhaps not so controversial solution.

Try working with the code on your own machine and messing with some parameters? What happens to the odds when we change the number of doors to 4 or more and how might we set sup a similar experiment?
